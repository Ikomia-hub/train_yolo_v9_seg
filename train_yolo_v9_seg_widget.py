...
from train_yolo_v9_seg.train_yolo_v9_seg_process import TrainYoloV9SegParam
...
# --------------------
class TrainYoloV9SegWidget(core.CWorkflowTaskWidget):

    def __init__(self, param, parent):
        core.CWorkflowTaskWidget.__init__(self, parent)

        if param is None:
            self.parameters = TrainYoloV9SegParam()
        else:
...
# --------------------
class TrainYoloV9SegWidgetFactory(dataprocess.CWidgetFactory):

    def __init__(self):
        dataprocess.CWidgetFactory.__init__(self)
        # Set the algorithm name attribute -> it must be the same as the one declared in the algorithm factory class
        self.name = "train_yolo_v9_seg"

    def create(self, param):
        # Create widget object
        return TrainYoloV9SegWidget(param, None)
